        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu to-top dropdown-menu-lg p-0">
                           ...
                           class="px-24 py-12 d-flex align-items-start gap-3 mb-2 justify-content-between">
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-sm text-secondary-light text-w-200-px">Bạn đã xác minh tài khoản thành công...</p>
                                </div>
                            </div>
                    ...
                    <div class="text-center py-12 px-16">
                        <a href="javascript:void(0)" class="text-primary-600 fw-semibold text-md">Xem tất cả thông báo</a>
                    </div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu to-top dropdown-menu-sm">
                    <div
                        ...
                        <div>
                            <h6 class="text-lg text-primary-light fw-semibold mb-2">Dang Phu An</h6>
