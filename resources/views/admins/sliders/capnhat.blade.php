            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            <form action="{{route('admins.slider.update',$slider->id)}}" method="POST"
                                ...
                                <div class="card-body p-24">
                                    ...
                                    text-secondary-light px-16 py-12 radius-12 d-inline-flex align-items-center gap-2 bg-hover-neutral-200">
                                        ...
                                        <input type="file" class="form-control w-auto mt-24 form-control-lg"
                                               id="file-upload"
                                               name="hinh_anh" value="{{$slider->hinh_anh}}" onchange="showImg(event)" hidden >
                                    </label>
                                    <img class="d-inline" src="{{ Storage::url($slider->hinh_anh) }}" id="uploaded-img" style="display: none; width: 100px">
                                </div>
                                <div class="mb-20">
                                    ...
                                    <input type="text"
                                           ...
                                           name="mo_ta"
                                           placeholder="Mô tả" value="{{$slider->mo_ta}}">
                                ...
                                <div class="text-center mt-3">
                                    <a href="{{route('admins.slider.index')}}" class="btn btn-light-100 text-dark "><i
