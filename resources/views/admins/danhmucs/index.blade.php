            ...
            <table class="table bordered-table mb-0">
                ...
                <tbody>
                    @foreach ($data as $index => $item)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td><img src="{{ \Illuminate\Support\Facades\Storage::url($item->hinh_anh) }}" alt=""
                                    width="70px"></td>
                            <td>{{ $item->ten_danh_muc }}</td>
                            <td>
                                <span
                                    class="{{ $item->trang_thai == true ? 'bg-success-focus text-success-main px-24 py-4 rounded-pill fw-medium text-sm' : 'bg-danger-focus text-danger-main px-24 py-4 rounded-pill fw-medium text-sm' }}">
