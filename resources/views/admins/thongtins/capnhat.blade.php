            ...
            <div class="row justify-content-center">
                <div class="col-xxl-6 col-xl-8 col-lg-10">
                    <div class="card border">
                        <div class="card-body">
                            <form action="{{route('admins.thongtin.update',$thongtin->id)}}" method="POST"
                                ...
                                <div class="mb-20">
                                  ...
                                  <input type="text" class="form-control radius-8" name="email"
                                      placeholder="Nhập email" value="{{$thongtin->email}}" required>
                              </div>
                              <div class="mb-20">
                                <label class="form-label fw-semibold text-primary-light text-sm mb-8">Số điện thoại
                                    <span class="text-danger-600">*</span></label>
                                <input type="text" class="form-control radius-8" name="phone_number " value="{{$thongtin->phone_number}}"
                                ...
                                <div class="card-body p-24">
                                    ...
                                    <img class="d-inline" src="{{ Storage::url($thongtin->logo) }}" id="uploaded-img" style="display: none; width: 100px">
                                </div>
                                <div class="mb-20">
                                  <label class="form-label fw-semibold text-primary-light text-sm mb-8">Địa chỉ <span class="text-danger-600">*</span></label>
                                  <input type="text" class="form-control radius-8" name="address" value="{{$thongtin->address}}" required>
                              </div>
